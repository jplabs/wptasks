...
class Woo_Hook_Manager {
	...
	public function register_screen_id ( $screens ) {
		if ( ! in_array( 'woo-hook-manager', $screens ) ) {
			$screens[] = 'woo-hook-manager';
		}
		return $screens;
	...
	public function admin_screen () {
		do_action( 'wf_screen_get_header', 'woo-hook-manager', 'themes' );

		// Keep the screen XHTML separate and load it from that file.
		include_once( $this->plugin_path . '/screens/admin.php' );

		do_action( 'wf_screen_get_footer', 'woo-hook-manager', 'themes' );
	} // End admin_screen()
